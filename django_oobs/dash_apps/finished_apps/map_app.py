...
app = DjangoDash('map_app', external_stylesheets=external_stylesheets)
...
def render_tab_content(active_tab, clickData, session_state=None, **kwargs):
    ...
    if not csf:
        ...
        csf['clicks'] = clickData

    return "Button has been clicked %s times since the page was rendered" % clickData
    print(active_tab)
