...
# file = 'http://thredds.aodn.org.au/thredds/dodsC/IMOS/ANMN/QLD/NWSBRW/hourly_timeseries/IMOS_ANMN-QLD_VZ_20190731_NWSBRW_FV02_velocity-hourly-timeseries_END-20210505_C-20211221.nc'
...
# ds = (getVariable(file,
#             'VCUR', False))
# # ds = getVariable('http://thredds.aodn.org.au/thredds/dodsC/IMOS/ANMN/QLD/PIL050/velocity-hourly_timeseries/IMOS_ANMN-QLD_BOSTZ_20120221_PIL050_FV02_hourly-timeseries_END-20140816_C-20210428.nc',
# #                    'VCUR')
# print(ds)
# df = ds.to_dataframe()
# print(df.head())
